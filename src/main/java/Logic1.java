...
public class Logic1
{
    ...
    public boolean lastDigit(int a, int b, int c) {
       ...
       char digitAtA = A.charAt(A.length()-1);
       String B = Integer.toString(b);
       char digitAtB = B.charAt(B.length()-1);
       String C = Integer.toString(c);
       char digitAtC = C.charAt(C.length()-1);
       if (digitAtA == digitAtB || digitAtB == digitAtC || digitAtC == digitAtC) {
           return true;
       } else {
           return false;
       }
